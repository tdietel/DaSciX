...
fx <- function(vx,vy,vz,px,py,pz,phi,q,m){
  B <- 2 #kiloGauss
  time <- seq(0,0.000001,length.out = 1000)
  #m <- m*(1.783*10^-36) #Gev/c^2 to kilogram
  c <- 299792458 #m/s speed of light
  
  # px <- px/1000 #MeV to GeV
  # py <- py/1000
  # pz <- pz/1000
...
par(mfrow=c(2,1))
scatter3D(test2$Xpos, test2$Ypos, test2$Zpos,phi=0,col="red",ticktype="detailed")
scatter3D(a$x,a$y,a$z,phi=0,col="black",ticktype="detailed")
```
