...
/// Fill the user stack (derived from TVirtualMCStack) with primary particles.
    ...
    // Read Particles from file and add to stack

    std::ifstream infile("InitialParticles.txt");

    Int_t pdg;
    Double_t Px, Py, Pz, E, Vx, Vy, Vz, T, polx, poly, polz;

    while (infile >> pdg >> Px >> Py >> Pz >> E >> Vx >> Vy >> Vz >> T >> polx >> poly >> polz)
    {

            // Add particle to stack
            fStack->PushTrack(toBeDone, -1, pdg, Px, Py, Pz, E, Vx, Vy, Vz, T, polx, poly, polz,
                                kPPrimary, ntr, 1., 0);
